...
+ (instancetype) objectWithArray:(NSArray *)arr withFuturesType:(NSString *)futuresType{
    ...
    for (NSDictionary *valueDic in arr)
    {
        ...
        [model initWithDic:valueDic];
        model.ParentGroupModel = groupModel;
        model.futuresType = futuresType;
    ...
    firstModel.futuresType = futuresType;
